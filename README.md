...
- they need to be prompted to carry out my intent — LLMs are the best
  prompters (and intent is figured out during the process of coding);
...
- Feedback loopable
  ([ampcode](https://ampcode.com/notes/feedback-loopable)): Agents are
